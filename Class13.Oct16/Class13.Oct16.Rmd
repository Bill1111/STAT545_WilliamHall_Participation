...
RColorBrewer::display.brewer.all() #this shows you all the different types of colors you can use
p_scales +
    scale_x_log10(labels=dollar_format()) +
...
ggplot(iris, aes(Sepal.Width, Sepal.Length)) +
     ...
     labs(x = "Sepal Width",
          ...
          title = "Sepal sizes of three plant species") +
    theme_bw() +
    theme(axis.text = element_text(size = 16), # want to modify text, therefore use element_text function
          strip.background = element_rect(fill = "orange"),
          panel.background = element_rect(fill = "blue")) # element_rect() b/c rectangle
```
...
p %>% 
    ggplotly() %>% 
    htmlwidgets::saveWidget("~/Documents/UBC/Term 7 - Sept. 2018/STAT 545/Participation/STAT545_Participation/Class13.Oct16")
```
