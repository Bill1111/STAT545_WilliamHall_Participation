...
`expand` vs `complete` (trim vs keep everything). Together with `nesting`. Check out the Examples in the `expand` documentation. Expand() gives you all possible combinations of the two variables you put in there.
