...
```{r}
simple_page %>% html_structure() #this will give you the structure of the code, but won't give you the content.
```
...
simple_page %>% html_text() #just gives you raw text - single vector of length 1.

simple_page %>% html_text() %>% cat() #just gives you raw text - single vector of length 1. The cat() gives this to you without the /n
...
```{r}
simple_page %>% 
	html_nodes("p") %>% #this gives you the stuff inbetween the p tags
  html_text() #this gives you just the text from that

simple_page %>% 
	html_nodes("a") %>% #this gives you the stuff inbetween the a tags
  html_text() #this gives you just the text from that
...
```{r}
KaneBrown <- read_html("https://www.musixmatch.com/search/kane%20brown")
